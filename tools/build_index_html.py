...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .three-option-group, .fabric-option-group {
      display: flex;
      align-items: center;
      gap: 0.5rem;
      font-size: 0.8rem;
    ...
    .three-option-label, .fabric-option-label {
      color: var(--text-muted);
      font-weight: 600;
      font-size: 0.74rem;
      text-transform: uppercase;
...
<body>
  ...
  <script>
    ...
    // --- Dynamiczne uzupełnianie wyboru w symulatorze ściegu ---
    function populateFabricCamSelect() {
      const select = document.getElementById('fabricCamSelect');
      if (!select) return;
      select.innerHTML = '';
