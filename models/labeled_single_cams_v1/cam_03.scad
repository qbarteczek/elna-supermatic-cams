/*
  Elna Supermatic single cam 03
  Name: Basic zigzag
  Status: STL-reference/candidate
...
module raised_stitch_preview() {
            translate([-4.0250, 13.1000, disc_thickness])
                rotate([0,0,77.5295])
                    cube(size=[5.3256, 0.7000, 0.8000], center=false);
            translate([-2.8750, 13.1000, disc_thickness])
                rotate([0,0,-77.5295])
                    cube(size=[5.3256, 0.7000, 0.8000], center=false);
            translate([-1.7250, 13.1000, disc_thickness])
                rotate([0,0,77.5295])
                    cube(size=[5.3256, 0.7000, 0.8000], center=false);
            translate([-0.5750, 13.1000, disc_thickness])
                rotate([0,0,-77.5295])
                    cube(size=[5.3256, 0.7000, 0.8000], center=false);
            translate([0.5750, 13.1000, disc_thickness])
                rotate([0,0,77.5295])
