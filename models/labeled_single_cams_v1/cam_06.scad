...
module raised_stitch_preview() {
            translate([-4.1400, 13.1000, disc_thickness])
                rotate([0,0,79.9669])
                    cube(size=[5.2808, 0.7000, 0.8000], center=false);
            translate([-3.2200, 13.1000, disc_thickness])
                rotate([0,0,-79.9669])
                    cube(size=[5.2808, 0.7000, 0.8000], center=false);
            translate([-2.3000, 13.1000, disc_thickness])
                rotate([0,0,79.9669])
                    cube(size=[5.2808, 0.7000, 0.8000], center=false);
            translate([-1.3800, 13.1000, disc_thickness])
                rotate([0,0,-79.9669])
                    cube(size=[5.2808, 0.7000, 0.8000], center=false);
            translate([-0.4600, 13.1000, disc_thickness])
                rotate([0,0,79.9669])
                    cube(size=[5.2808, 0.7000, 0.8000], center=false);
            translate([0.4600, 13.1000, disc_thickness])
                rotate([0,0,-79.9669])
